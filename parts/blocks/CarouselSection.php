...
<div class="carousel-section grid-container">
    ...
    <?php if (have_rows('slides')) : ?>
        <?php
        $response = '"responsive":[';
        $response .= '{"breakpoint":1260,"settings":{"slidesToShow":4}},';
        $response .= '{"breakpoint":1024,"settings":{"slidesToShow":3}},';
        $response .= '{"breakpoint":800,"settings":{"slidesToShow":2,"slidesToScroll":2}},';
        $response .= '{"breakpoint":420,"settings":{"slidesToShow":1,"slidesToScroll":1,"dots":false}}';
        $response .= ']';
        ?>
        <div class="carousel-frame">
            <div class="carousel-slider" data-slick-slider
                 data-slick='{"dots": true, "slidesToShow":5, "slidesToScroll":3, "infinite":true, <?php echo $response; ?>}'>
                <?php while (have_rows('slides')) : the_row(); ?>
                    <div class="slide">
                        ...
                        <div class="image text-center" style="background: url(<?php echo $imageURL; ?>) no-repeat; background-size: cover;">
